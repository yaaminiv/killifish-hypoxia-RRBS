...
head(stackedBarplotData) #Confirm formatting
stackedBarplotData %>%
...
stackedBarplotData %>%
  ...
  theme_classic(base_size = 13) #Take stacked barplot data and remove total column. Create a new column, treatment2, that reorganized treatment information in a logical order. Pivot dataframe longer to use for plotting. Create a stacked barplot (position = "fill"). Modify x- and y-axes.
ggsave("CpG-stacked-barplot.pdf", width = 11, height = 8.5)
```

...
chmod +x /vortexfs1/home/yaamini.venkataraman/08-BAT-correlating.sh
...
#Run BAT_correlating
singularity exec --env-file /vortexfs1/home/yaamini.venkataraman/08-correlating-envfile.txt \
...
/yaaminiv/08-BAT-correlating.sh

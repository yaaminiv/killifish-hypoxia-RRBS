...
#SBATCH --job-name=yrv_directional         							 						   	# Job name
...
#SBATCH --output=yrv_directional%j.log  								   				  		# Standard output/error
#SBATCH --chdir=/vortexfs1/scratch/yaamini.venkataraman/02-directional	# Working directory for this script
...
--output_dir /vortexfs1/scratch/yaamini.venkataraman/02-directional \
--fastqc_args \
"--outdir /vortexfs1/scratch/yaamini.venkataraman/02-directional \
--threads 28" \
--rrbs \
--paired \
...
/vortexfs1/scratch/yaamini.venkataraman/02-directional/.
